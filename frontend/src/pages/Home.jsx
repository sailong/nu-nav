...
import { ExternalLink, ChevronUp, Github } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto flex flex-col flex-1">
        <header className="flex justify-between items-center px-6 py-6 md:px-12">
            ...
            <a 
              ...
              className="bg-white/10 hover:bg-white/20 backdrop-blur-sm p-2 rounded-full text-white/90 transition-all hover:scale-110"
